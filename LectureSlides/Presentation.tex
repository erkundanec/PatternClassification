...
%\input{./Chapters2020/Lec04_EstimationTechniques}
%\input{./Chapters2020/Lec05_DimenProblem.tex}           % video lectures are prepared
%\input{./Chapters2020/Lec06_LinearDiscriminant.tex}     % video lectures are prepared
\input{./Chapters2020/Lec07_SupportVectorMachine.tex}
%\input{./Chapters2020/Lec08_ArtificialNeuralNetwork.tex}
%\input{./Chapters2020/Lec09_Clustering.tex}

%% extra slides
%\input{./Chapters2020/Extra01_2DGaborFilters.tex}
%\input{./Chapters2020/Extra02_Anaconda.tex}
\end{document}
